...
<div  id="myForm" >
  ...
  <table>
    <tr>
      ...
      <td> <input id="buttonSubmit2"  style="height:30px;width:160px;margin-right:20px;margin-top:10px;" type="submit" formaction="motions_list.php" name="back_to_motions" value="חזרה לרשימת תנועות"></td>
      <td></td>
