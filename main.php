...
<div id="home" align="center" >
  ...
  <tr >
    <td style="text-align:center;border:1px solid #880000;"><a href="motion_add.php"><img src="img/motion.png"></a></td>
     <td style="width:20px;"></td>
    <td style="text-align:center;border:1px solid #880000;"><a href="product_add.php"><img src="img/inventory.png"></a></td>
     <td style="width:20px;"></td>
    <td style="text-align:center;border:1px solid #880000;"><a href="reports.php"><img src="img/report.png"></a></td>
  </tr>
  <tr >
