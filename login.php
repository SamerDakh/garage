...
<!--start header--> <div id="header">  <img src="img\garage-icon.png" alt="logo" height="100" width="100"><h2 id="title">מוסך מדין מרעי
</h2></div><!---close header-->
...
echo "$msg";
  ...
  <tr>
    <td></td>
    <td  ><input id="buttonSubmit1"  style="height:30px;width:175px;margin-top:10px;font-family: arial;" type="submit" name="submit"  value="כניסה"></td>
  </tr>
  </form>
</table>
</td>
