...
<input style="margin-right:10px;" type="date" name="to" >      
   ...
   <tr>
      <td> <input id="buttonSubmit1"  style="height:30px;width:200px;margin-right:150px;margin-top:10px;" type="submit" name="add1"  value="הצג">
      
   </tr><br><br><br><hr><br><br> 
...
<td> <input id="buttonSubmit1"  style="height:30px;width:200px;margin-right:150px;margin-top:10px;" type="submit" name="add2"  value="הצג">
